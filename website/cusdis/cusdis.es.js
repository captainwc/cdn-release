...
const makeIframeContent = (target) => {
  ...
  const iframeJsPath = target.dataset.iframe || 'https://cdn.jsdelivr.net/gh/captainwc/cdn-release/website/cusdis/iframe.umd.min.js'
  const cssPath = 'https://cdn.jsdelivr.net/gh/captainwc/cdn-release/website/cusdis/style.min.css'
  return `<!DOCTYPE html>
<html>
  <head>

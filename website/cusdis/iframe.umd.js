(function ($) {
    ...
    function be(t, e, r, n, l, i, a, c, s, o, f, u) {
        ...
        for (; v && k;) {
            ...
            _ === S ? (f = _.first,
                v--,
                k--) : L.has(y) ? !a.has(h) || E.has(h) ? N(_) : C.has(y) ? v-- : M.get(h) > M.get(y) ? (C.add(h),
                    N(_)) : (E.add(y),
                        v--) : (s(S, a),
                            v--)
        }
    ...
    function ce(t, e, r, n, l, i, a, c = [-1]) {
        ...
        a && a(o.root);
        let f = !1;
        if (o.ctx = r ? r(t, e.props || {}, (u, v, ...k) => {
            const g = k.length ? k[0] : v;
            return o.ctx && l(o.ctx[u], o.ctx[u] = g) && (!o.skip_bound && o.bound[u] && o.bound[u](g),
                f && Je(t, u)),
                v
        }
        ) : [],
    ...
    class fe {
        ...
        $set(e) {
            this.$$set && !xe(e) && (this.$$.skip_bound = !0,
                this.$$set(e),
                this.$$.skip_bound = !1)
        }
    }
        ...
        , Ye = function t(e) {
            ...
            function n(l, i, a, c) {
                ...
                (o.transformRequest || []).map(function (g) {
                    ...
                    u && typeof u == "object" && typeof u.append != "function" && (u = JSON.stringify(u),
                        f["content-type"] = "application/json");
                var v = typeof document != "undefined" && document.cookie.match(RegExp("(^|; )" + o.xsrfCookieName + "=([^;]*)"));
                if (v && (f[o.xsrfHeaderName] = v[2]),
                    o.auth && (f.authorization = o.auth),
                    o.baseURL && (l = l.replace(/^(?!.*\/\/)\/?(.*)$/, o.baseURL + "/$1")),
                    o.params) {
                    var k = ~l.indexOf("?") ? "&" : "?";
                ...
                return (o.fetch || fetch)(l, {
                    ...
                    for (var b in g)
                        typeof g[b] != "function" && (s[b] = g[b]);
                    var m = o.validateStatus ? o.validateStatus(g.status) : g.ok;
                    return o.responseType == "stream" ? (s.data = g.body,
                        s) : g[o.responseType || "text"]().then(function (L) {
                            s.data = L,
                                s.data = JSON.parse(L)
    ...
    function A(t) {
        const r = window["CUSDIS_LOCALE"] || ye
            , n = r[t] || ye[t];
        return r[t] || console.warn("[cusdis]", "translation of language key", `'${t}'`, "is missing."),
            n
    }
    function Ke(t) {
        let e, r, n, l, i, a, c, s, o, f, u, v, k, g, b, m, L, M, E, C = (t[3] ? A("sending") : A("post_comment")) + "", N, _, S;
        return {
            c() {
                e = w("div"),
                    r = w("div"),
                    ...
                    p(l, "for", "nickname"),
                    p(a, "name", "nickname"),
                    p(a, "class", "w-full p-2 border border-gray-200 bg-transparent dark:text-gray-100 dark:outline-none"),
                    p(a, "type", "text"),
                    p(a, "autocomplete", "off"),
                    p(a, "title", A("nickname")),
                    p(n, "class", "px-1"),
                    p(o, "class", "mb-2 block dark:text-gray-200"),
                    p(o, "for", "email"),
                    p(u, "name", "email"),
                    p(u, "class", "w-full p-2 border border-gray-200 bg-transparent dark:text-gray-100 dark:outline-none"),
                    p(u, "type", "email"),
                    p(u, "autocomplete", "off"),
                    p(u, "title", A("email")),
                    p(s, "class", "px-1"),
                    ...
                    p(m, "class", "w-full p-2 border border-gray-200 h-24 bg-transparent dark:text-gray-100 dark:outline-none"),
                    p(m, "title", A("reply_placeholder")),
                    p(k, "class", "px-1"),
                    p(E, "class", "text-sm bg-gray-200 p-2 px-4 font-bold dark:bg-transparent dark:border dark:border-gray-100"),
            ...
            m(h, y) {
                T(h, e, y),
                    ...
                    d(M, E),
                    d(E, N),
                    _ || (S = [F(a, "input", t[7]), F(u, "input", t[8]), F(m, "input", t[9]), F(E, "click", t[4])],
                        _ = !0)
            },
            p(h, [y]) {
                y & 2 && a.value !== h[1] && D(a, h[1]),
                    ...
                    y & 1 && D(m, h[0]),
                    y & 8 && C !== (C = (h[3] ? A("sending") : A("post_comment")) + "") && X(N, C),
        ...
        return {
            c() {
                e = w("div"),
                    ...
                    p(e, "class", "mr-2 dark:bg-gray-500 bg-gray-200 text-xs py-0.5 px-1 rounded dark:text-gray-100")
            },
            m(n, l) {
                T(n, e, l),
                    d(e, r)
    ...
    function Ce(t) {
        let e = [], r = new Map, n, l, i = t[1].replies.data;
        const a = c => c[6].id;
    ...
    function We(t) {
        let e, r, n, l = (t[1].moderator && t[1].moderator.displayName ? t[1].moderator.displayName : t[1].by_nickname) + "", i, a, c, s, o = t[1].parsedCreatedAt + "", f, u, v, k = t[1].parsedContent + "", g, b, m, L, M, E, C, N, _ = t[1].moderatorId && ve(), S = t[1].replies.data.length > 0 && Ce(t), h = t[0] && Le(t);
        return {
            c() {
                e = w("div"),
                    r = w("div"),
    ...
    function Oe(t) {
        let e, r, n, l, i, a, c, s, o, f, u, v, k, g, b, m = t[4] && Re(t);
        n = new ke({});
        const L = [Ve, Qe]
            , M = [];
        function E(C, N) {
            ...
            o = M[s] = L[s](t),
        {
            c() {
                e = w("div"),
                    ...
                    p(k, "class", "text-center text-gray-500 dark:text-gray-100 text-xs"),
                    q(e, "dark", t[1] === "dark")
            },
            m(C, N) {
                T(C, e, N),
    ...
    function Qe(t) {
        let e = [], r = new Map, n, l, i, a = t[0].data;
        const c = o => o[15].id;
        ...
        return {
            ...
            p(o, f) {
                f & 1 && (a = o[0].data,
                    ...
                    J()),
                    o[0].pageCount > 1 ? s ? s.p(o, f) : (s = Ie(o),
                        s.c(),
                        s.m(l.parentNode, l)) : s && (s.d(1),
                            s = null)
            },
            i(o) {
                if (!i) {
    ...
    function Ze(t, e, r) {
        let { attrs: n } = e, { commentsResult: l } = e, i = 1, a = !0, c = "", s, o = n.theme || "light";
        const f = Ye.create({
            baseURL: n.host
        });
        function u(b) {
        ...
        return t.$$set = b => {
            ...
            ,
            t.$$.update = () => {
                t.$$.dirty & 2 && document.documentElement.style.setProperty("color-scheme", o)
            }
            ,
            [l, o, i, a, c, s, k, n, g]
    }
